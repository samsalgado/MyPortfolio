...
const VidGallery = () => {
    const [videos] = useState([
      ...
      'https://www.youtube.com/embed/oRBnPNRYjtY',
      'https://www.youtube.com/embed/sJWd_78LzVw?si=Y0lGtJ7y516CDSqh',
      'https://www.youtube.com/embed/z0bxK2xKXFw?si=L8vaSZ-g-PCu_4aY',
    ...
    return (
      <div className='video-gallery'>
        {videos.slice(0, initialVideosToShow).map((videoUrl, index) => (
          <Iframe
            key={index}
